      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-10 sm:px-6 lg:grid-cols-[1fr_360px] lg:px-8">
        <div className="space-y-10">
          <div>
            ...
            <p className="mt-3 text-base text-cool-500">{course.subtitle}</p>
          ...
          <section>
            ...
            <p className="mt-3 text-sm leading-relaxed text-cool-700">{course.description}</p>
          </section>
          ...
          <section className="rounded-2xl border border-cool-100 p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-cool-500">{course.instructor.headline}</p>
              </div>
            </div>
            <p className="mt-4 text-sm leading-relaxed text-cool-700">{course.instructor.bio}</p>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex text-amber-500">
                      {Array.from({ length: 5 }).map((_, i) => (
                        <Star key={i} size={14} fill={i < review.rating ? "currentColor" : "none"} className={i >= review.rating ? "text-cool-200" : ""} />
                      ))}
                    </div>
                  </div>
  ...
  return (
    <div className="lg:sticky lg:top-24 lg:self-start">
      <div className="overflow-hidden rounded-2xl border border-cool-100 bg-white text-ink shadow-cardHover">
        <CourseThumb seed={course.id} categoryIcon={course.category.icon} className="h-44 w-full" />
        <div className="p-5">
