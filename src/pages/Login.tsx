    ...
    <div className="flex h-screen">
      <Reveal variant="liquidGlass" duration={800} className="relative hidden flex-1 items-center justify-center overflow-hidden bg-gradient-to-br from-[#10CDB2] via-[#0BA391] to-[#0891b2] lg:flex">
        ...
        <div className="relative z-10 max-w-md px-8 text-white">
          <h2 className="font-display text-4xl font-bold leading-tight">
            Welcome Back to <span className="text-white/90">Curio</span>
          </h2>
          <p className="mt-4 text-base leading-relaxed text-white/75">
            Continue your learning journey. Pick up right where you left off and explore thousands of courses.
          </p>
        </div>
      </Reveal>
      ...
      <Reveal variant="fadeUp" duration={600} delay={120} className="flex flex-1 items-center justify-center overflow-y-auto bg-white px-6">
        <div className="w-full max-w-sm py-6">
          ...
          <h1 className="text-center font-display text-xl font-bold text-ink">Welcome back</h1>
          <p className="mt-1 text-center text-sm text-cool-500">Log in to keep learning where you left off.</p>

          {isDemo && (
            <p className="mt-3 rounded-xl bg-mint-50 px-3 py-2 text-xs text-mint-800">
              Demo mode: any email/password signs you in locally. Connect Supabase for real accounts.
            </p>
          )}
          ...
          <p className="mt-4 text-center text-sm text-cool-500">
            New to Curio?{" "}
            <Link to="/signup" className="font-semibold text-[#10CDB2] hover:text-[#0BA391]">
              Create an account
            </Link>
          </p>
        </div>
